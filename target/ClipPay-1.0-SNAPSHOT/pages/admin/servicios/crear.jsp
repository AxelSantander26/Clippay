...
<html>
<head>
    <title>Nuevo Servicio - ClipPay</title>
...
<div class="container">
    <div class="card">
        <h1>
            <img src="${pageContext.request.contextPath}/assets/resources/icons/plus.svg" alt="nuevo">
            Nuevo Servicio
        </h1>
        
        <div class="info-box">
            <img src="${pageContext.request.contextPath}/assets/resources/icons/information-circle.svg" alt="info">
            La comisión es el porcentaje que recibe el barbero por este servicio.
        </div>
        ...
        <form action="${pageContext.request.contextPath}/admin/servicios" method="post">
            ...
            <div class="field">
                ...
                <input type="text" name="nombre" placeholder="Ej: Corte de cabello" required>
            </div>
            ...
            <div class="row">
                ...
                <div class="field">
                    ...
                    <input type="number" name="comision" step="0.01" min="0" max="100" placeholder="0" required>
                </div>
            </div>
